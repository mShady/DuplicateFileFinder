...
8. **Commit Code Changes:**
   ...
   - Commit with a conventional message and the task summary:
     ```bash
     git commit -m "<type>(<scope>): <subject>" -m "Task Summary: <summary>"
     ```
     *Note: Ensure the commit message clearly describes the granular change.*
